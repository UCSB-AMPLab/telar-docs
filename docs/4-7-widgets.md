...
nav_order: 7
lang: en
permalink: /docs/your-content/widgets/
---
...
- [Stories & Panels](/docs/your-content/stories-panels/) — Using widgets in story panels
- [Custom Pages](/docs/site-features/custom-pages/) — Using widgets in standalone pages
- [Markdown Syntax Guide](/docs/your-content/markdown-syntax/) — All formatting options
