---
layout: docs
title: "8.3. Arquitectura del sistema de demos"
...
def merge_glossary(demo_glossary):
    # Escrito en _data/demo-glossary.json (no telar-content/)
...
- [Contenido de Demostración (Guía de Usuario)](/guia/personalizacion/contenido-demostracion/) - Documentación para usuarios
