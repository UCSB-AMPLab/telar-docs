...
- [Páginas Personalizadas](/guia/funciones/paginas-personalizadas/) - Crear páginas para enlazar en la navegación
- [Referencia de Configuración](/guia/configurar/configuracion/) - Opciones completas de `_config.yml` incluyendo `telar_language`
