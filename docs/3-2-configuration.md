---
layout: docs
title: "3.2. Configuration Reference"
parent: "3. Configure Your Site"
grand_parent: Documentation
nav_order: 2
lang: en
permalink: /docs/configure/configuration/
---
...
3. Paste the published URL into `_config.yml`
4. Set `enabled: true`
5. Commit changes
...
{: .note }
> Only the published URL is needed. If your config still has a `shared_url` line from an older version, it is safely ignored.

See [Google Sheets Reference](/docs/your-data/google-sheets/) for complete setup instructions.
...
See [Demo Content](/docs/customization/demo-content/) for complete details on available demos.
...
- [Config Validator](/docs/configure/config-validator/) — Check your `_config.yml` for common errors
- [Config Generator and Editor](/docs/configure/config-generator/) — Generate or edit a `_config.yml` file
...
- [Demo Content](/docs/customization/demo-content/)
- [Private Stories](/docs/site-features/private-stories/)
- [CSV Reference: Project](/docs/your-data/csv-project/)
