---
layout: docs
title: "3.3. Config Validator"
parent: "3. Configure Your Site"
grand_parent: Documentation
nav_order: 3
lang: en
permalink: /docs/configure/config-validator/
extra_css:
  - config-tools
---
...
- [Configuration Reference](/docs/configure/configuration/) — Full list of all `_config.yml` settings
