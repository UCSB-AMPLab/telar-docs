...
- The IIIF viewer renders correctly inside the embed

**Embed structure:**
- Telar story (iframe 1)
  - OpenSeadragon viewer (rendered inline, not a nested iframe)
...
- **Educator Guide**: [Embedding in LMS & Websites](/docs/site-features/embedding/)
