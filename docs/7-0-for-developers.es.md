...
### [7.1 Desarrollo local](/guia/desarrolladores/desarrollo-local/)
Configura tu entorno de desarrollo, ejecuta compilaciones localmente y prueba cambios antes de desplegar.

### [7.2 GitHub Actions](/guia/desarrolladores/github-actions/)
...
1. **Configura desarrollo local** (7.1) para probar tus cambios
2. **Entiende el sistema de compilación** (7.2, 7.3) para ver cómo se procesa el contenido
...
- [Referencia de Configuración](/guia/referencia/configuracion/) - Todas las opciones de _config.yml
- [Referencia CSV: proyecto y objetos](/guia/referencia/csv-proyecto-objetos/) - Documentación de columnas CSV
