...
Consulta la [Referencia CSV: Proyecto y Objetos](/guia/tus-datos/csv-proyecto/#project-csv-projectcsv--proyectocsv) para todas las columnas de project.csv.
...
- [Referencia CSV: Historias](/guia/tus-datos/csv-historias/) — Referencia completa de columnas para los CSV de historias
