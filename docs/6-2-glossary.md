...
nav_order: 2
lang: en
permalink: /docs/site-features/glossary/
---
...
- [CSV Reference: Glossary](/docs/your-data/csv-glossary/) — Complete glossary CSV column reference and aliases
- [Stories & Panels](/docs/your-content/stories-panels/) — Where glossary links are used
- [Markdown Syntax Guide](/docs/your-content/markdown-syntax/) — Formatting for definitions
