...
Consulta [Configuración](/guia/referencia/configuracion/#story-protection) para detalles sobre la opción `story_key`.

## Véase también

- [Historias y Paneles](/guia/estructura-de-contenido/historias-paneles/) — Cómo construir historias
- [Referencia CSV: Proyecto y Objetos](/guia/referencia/csv-proyecto-objetos/) — La columna `protected` en project.csv
- [Configuración](/guia/referencia/configuracion/) — Clave de historia y opciones de interfaz
