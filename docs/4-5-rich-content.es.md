---
layout: docs
title: "4.5. Contenido enriquecido con Markdown"
parent: "4. Tu contenido"
grand_parent: Documentación
nav_order: 5
lang: es
permalink: /guia/tu-contenido/contenido-enriquecido/
---
...
- **Widgets** — elementos interactivos como acordeones, paneles con pestañas y carruseles de imágenes. Consulta la [Referencia de sintaxis Markdown](/guia/tu-contenido/sintaxis-markdown/) para la lista completa.
...
- [Referencia de sintaxis Markdown](/guia/tu-contenido/sintaxis-markdown/) — guía completa de formato con widgets y medios
- [Tu contenido](/guia/tu-contenido/) — cómo Telar organiza los archivos
- [Referencia CSV: Proyecto](/guia/tus-datos/csv-proyecto/) — columnas de CSV de proyecto y objetos
- [Referencia CSV: Historias](/guia/tus-datos/csv-historias/) — columnas de CSV de historias y glosario
