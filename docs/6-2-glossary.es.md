...
nav_order: 2
lang: es
permalink: /guia/funciones/glosario/
---
...
Agrega un archivo `glossary.csv` a `telar-content/spreadsheets/`:
...
- [Referencia CSV: Glosario](/guia/tus-datos/csv-glosario/) — Referencia completa de columnas del CSV de glosario y alias
- [Historias y Paneles](/guia/tu-contenido/historias-paneles/) — Dónde se usan los enlaces de glosario
- [Guía de Sintaxis Markdown](/guia/tu-contenido/sintaxis-markdown/) — Formato para definiciones
