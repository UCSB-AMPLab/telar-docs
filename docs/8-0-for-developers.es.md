...
### [8.2 Referencia de GitHub Actions](/guia/desarrolladores/github-actions/)
...
### [8.4 Arquitectura del sistema de incrustación](/guia/desarrolladores/sistema-incrustacion/)
...
- [Referencia de Configuración](/guia/configuracion/) - Todas las opciones de _config.yml
- [Referencia CSV](/guia/referencia/csv-reference/) - Documentación completa de columnas CSV
