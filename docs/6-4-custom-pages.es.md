---
layout: docs
title: "6.4. Páginas personalizadas"
parent: "6. Funciones del sitio"
grand_parent: Documentación
nav_order: 4
lang: es
permalink: /guia/funciones/paginas-personalizadas/
---
...
Consulta [Referencia de Sintaxis Markdown](/guia/tu-contenido/sintaxis-markdown/) para documentación completa de widgets.
...
- Explora [sintaxis de widgets](/guia/tu-contenido/sintaxis-markdown/) para acordeón, pestañas y carruseles
- Consulta [configuración de glosario](/guia/funciones/glosario/) para configurar el enlace automático
